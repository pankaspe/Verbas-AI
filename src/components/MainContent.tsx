...
export function MainContent() {
  ...
  return (
    <>
      ...
      {/* FileBrowser pannello a comparsa */}
      <div
      ...
      >
        ...
        <div class="flex-1 flex justify-center items-start">
          <div class="max-w-4xl w-full px-4 py-6 relative">
            <div id="alert" role="alert" class="hidden absolute top-4 left-1/2 -translate-x-1/2 z-50 min-w-[500px] max-w-xl px-6 py-4">
